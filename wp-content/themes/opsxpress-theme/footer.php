<footer class="site-footer">
	...
	<div class="footer-container">
		<div class="footer-top">
			<div class="footer-brand reveal">
				<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="footer-logo" aria-label="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>">
					<img src="<?php echo esc_url( get_theme_mod( 'opsxpress_navbar_logo', get_theme_file_uri( 'assets/logo/Company logo navbar-B8ZEAKe_.svg' ) ) ); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" width="180" height="28" loading="lazy">
				</a>
		...
		<div class="footer-bottom">
			<p>&copy; <?php echo esc_html( date( 'Y' ) ); ?> <?php bloginfo( 'name' ); ?>. <?php esc_html_e( 'All rights reserved.', 'opsxpress' ); ?></p>
		</div>
	</div>
</footer>
